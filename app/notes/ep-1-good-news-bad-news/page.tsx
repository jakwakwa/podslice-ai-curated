        ...
        <div className="containe  mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-muted-foreground mb-6">
              We used these reports and articles to shape our discussion on macro trends, Bitcoin correlation, and the AI pivot:
            </p>

            <div className="space-y-8">
              <section>
                <h4 className="text-xl font-semibold mb-4 text-foreground-muted">Macroeconomics & Market Reaction</h4>
                <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
                  ...
                  <li>
                    <Link 
                      ...
                      className="text-blue-400 hover:text-blue-300 hover:underline"
                    >
                      North American Morning Briefing: AI Bubble Worries Ease, Focus Turns to Jobs Report
                    </Link>
                  </li>
                  <li>
                    <Link 
                  ...
                  <li>
                    <Link 
                      ...
                      className="text-blue-400 hover:text-blue-300 hover:underline"
                    >
                      The $1 Billion Company That Controls What AI Giants Can't Buy | Investing.com
                    </Link>
                  </li>
                </ul>
              </section>
              ...
              <section>
                <h4 className="text-xl font-semibold mb-4 text-foreground-muted">IREN & Miner Analysis</h4>
                <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
                  <li>
                    <Link 
                  ...
                  <li>
                    <Link 
                      ...
                      className="text-blue-400 hover:text-blue-300 hover:underline"
                    >
                      How Can IREN's Transition Into the AI Cloud Benefit the stock? - Nasdaq
                    </Link>
                  </li>
                  <li>
                    <Link 
                      ...
                      className="text-blue-400 hover:text-blue-300 hover:underline"
                    >
                      Gross Mining Margin Under Stress as Bitfarms Transitions to HPC/AI | Nasdaq
                    </Link>
                  </li>
                </ul>
              </section>
