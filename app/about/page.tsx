...
export default function AboutPage() {
	return (
		<>
			<LandingPageHeader />
			<div className="min-h-screen bg-linear-to-t to-transparent to-90% via-(--beduk-4)-chart-2 from-0%">
				{/* Hero Section */}
				<AboutHero />
				...
				<AboutSection
					...
					className="bg-linear-to-br from-(--swak-1)[via-(--swak-1)var(--swak-1)]">
				...
				<AboutSection
					...
					className="bg-linear-to-br from-(--swak-2) via-(--swak-1) to-(--swak-1)">
