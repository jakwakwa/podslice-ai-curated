...
export default async function MyEpisodesPage({ searchParams }: { searchParams?: Promise<SearchParams> }) {
	...
	return (
		<div className="my-blur animated-background h-full min-h-[84vh] rounded-none px-0 mx-0 md:mx-3 flex flex-col lg:rounded-3xl md:rounded-4xl md:mt-0 md:p-8 md:w-full md:gap-5 md:episode-card-wrapper bg-card">
			<PageHeader
