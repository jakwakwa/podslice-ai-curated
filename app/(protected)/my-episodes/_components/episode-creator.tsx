...
export function EpisodeCreator() {
  ...
  const canSubmit =
    creatorMode === "youtube" ? canSubmitYouTube : canSubmitNews;
  ...
  useEffect(() => {
    ...
    async function fetchMetadata() {
      console.log(
        "[DEBUG] fetchMetadata called with URL:",
        debouncedYoutubeUrl,
      );
      setYouTubeUrlError(null);
      if (isYouTubeUrl(debouncedYoutubeUrl)) {
        ...
        try {
          ...
          console.log(
            "[DEBUG] YouTube metadata API response status:",
            res.status,
          );
          if (!res.ok) {
            throw new Error(
  ...
  async function handleCreate() {
    ...
    try {
      ...
      if (!videoTitle) {
        ...
        setError(
          "Video title is required. Please wait for the video details to load.",
        );
        return;
      }
      ...
      if (!videoDuration) {
        ...
        setError(
          "Video duration could not be determined. Please try a different URL.",
        );
        return;
      }
      if (
        videoDuration >
        (maxDuration ? maxDuration * 60 : YT_MAX_DURATION_SECONDS)
      ) {
      ...
      console.log(
        "[DEBUG] handleCreate proceeding with YouTube episode creation",
      );
      const payload = {
        title: videoTitle,
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Failed to start episode generation.",
      );
      toast.error(
        (err instanceof Error
          ? err.message
        ...
        <div className="py-8 px-4 md:p-0 ">
          ...
          <div className="flex flex-col px-0 md:px-4  gap-4">
            ...
            <form
              ...
              onSubmit={(e) => {
                console.log(
                  "[DEBUG] Form onSubmit triggered, canSubmit:",
                  canSubmit,
                );
                e.preventDefault();
                ...
                if (!canSubmit) {
                  console.log(
                    "[DEBUG] Form submission blocked by canSubmit check",
                  );
                  return;
                }
                console.log(
                  "[DEBUG] Form submission proceeding to handleCreate",
                );
                void handleCreate();
              }}
            >
                  ...
                  <div className="w-[250px] flex flex-col gap-0 md:min-w-full ">
                    ...
                    <div className="flex flex-row gap-3 mt-4">
                      <Button
                        type="button"
                        variant={
                          generationMode === "single" ? "default" : "outline"
                        }
                      ...
                      <Button
                        type="button"
                        variant={
                          generationMode === "multi" ? "default" : "outline"
                        }
                    ...
                    {showTips && (
                      <div className="space-y-3 p-4 bg-primary/50 shadow-sm mb-4	 rounded-xl w-full min-w-full md:max-w-full md:min-w-full ">
                        <p className="text-xs font-semibold foreground/80">
                          Both options can handle 90% of any youtube URL you
                          provide! The quality of your generated episode depends
                          on the content you choose to upload. These tips can
                          help you decide if you're unsure:
                        </p>
                        <ul className="space-y-2 leading-relaxed text-primary-foreground text-xs mt-1 md:max-w-full ">
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              ...
                              If you're unsure, start with Single Speaker - it's
                              our most reliable option for any content type
                            </span>
                          </li>
                          <li className="flex my-1 content-center gap-2">
                            ...
                            <span>
                              ...
                              We recommend Single Speaker for faster processing
                          ...
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              ...
                              processes faster and is ideal for solo
                              presentations, tutorials, or monologues
                            </span>
                          </li>
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              ...
                              results will be generated into two speaker
                              conversational podcast syled episode. For more
                              engaging information consumption. May not be suite
                          ...
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              ...
                              Clear audio, minimal background noise, and
                          ...
                          <li className="flex items-start gap-2">
                            ...
                            <span>
                              ...
                              Music-heavy content, very fast speech, or videos
                              ...
                              <SelectItem key={v.name} value={v.name}>
                                <div className="flex items-center justify-between w/full gap-3 ">
                                  ...
                                  <button
                                    ...
                                    className="inline-flex items-center gap-1 text-xs opacity-80 hover:opacity-100 mt-3"
                                  ></button>
                                </div>
                              </SelectItem>
                            ))}
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription className="text-center space-y-4">
              <p>
                You've reached your monthly limit of {usage.limit} episodes for
                your current membership plan.
              </p>
              <p className="font-medium">
                To create more episodes, you'll need to upgrade your membership
