...
export function UsageDisplay() {
	...
	return (
		<div className=" w-full px-6 bg-black/10 mx-0  pt-6 lg:pt-12  pb-4 outline-0 border-l-0 lg:rounded-none lg:border-b-black lg:border-l lg:border-l-border lg:border-b-none sm:px-5 md:p-8 lg:w-[300px]">
