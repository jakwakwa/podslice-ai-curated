			...
			<div className="p-4 border border-destructive rounded-md space-y-3">
				...
				{is403 ? (
					<div className="text-sm space-y-2">
						<p>
							Your Paddle API key doesn't have permission to access notification settings.
						</p>
						...
						<ol className="list-decimal pl-5 space-y-1">
							...
							<li>
								Ensure it has <strong>write permissions</strong> and access to{" "}
								<strong>notification settings</strong>
							</li>
							<li>
								Update your{" "}
								<code className="bg-muted px-1 py-0.5 rounded">PADDLE_API_KEY</code>{" "}
