...
export function Footer() {
	return (
		<div className=" px-4 py-14 mb-0 w-screen md:-ml-4 bottom-0 md:w-[102%] flex flex-col gap-4 md:py-24 items-center justify-center text-xs overflow-hidden rounded-none md:bg-bigcard opacity-90 ">
