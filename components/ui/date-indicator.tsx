...
function DateIndicator({
	...
	label,
	size = "sm",
}: DateIndicatorProps): React.ReactElement {
	...
	if (!label) {
		return (
			<div
				className={`flex py-0 pl-1 h-auto leading-none font-normal mr-1 ${sizeClasses[size]} no-wrap font-mono text-primary-foreground   text-[0.55rem]`}>
	...
	return (
		<div
			className={`w-full px-1 text-center inline py-0 mr-1  text-primary-foreground shadow-md h-auto tracking-tighter leading-none ${sizeClasses[size]} font-mono no-wrap `}>
