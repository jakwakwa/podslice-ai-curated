	...
	"inline-flex items-center text-primary border-none content-center outline outline-1 justify-center rounded border px-2 py-0 font-light transition-colors focus:outline-none focus:ring-2 rounded-sm text-foreground focus:ring-ring focus:ring-offset-2 h-5 text-[0.6rem] text-center",
	{
		variants: {
			variant: {
				...
				status:
					"outline-1 outline-emerald-700 bg-emerald-950/70 text-left overflow-hidden   text-emerald-100 font-light outline-1 rounded-sm animate-pulse shadow-md min-h-6",
				destructive:
				...
				outline:
					"text-xs flex  outline-1 outline-emerald-700 bg-emerald-950/30  font-sans items-center  min-h-5 shadow-md  px-2 py-1 text-left overflow-hidden rounded-xs",
			},
		},
		defaultVariants: {
			variant: "default",
