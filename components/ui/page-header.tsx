        ...
        <div className="flex flex-col justify-center w-full gap-3">
          ...
          {description && (
            <Typography
              as="p"
              variant="body"
              className="text-base font-medium md:text-[1rem] p-0  md:px-0  md:py-0  text-white/80 leading-normal max-w-screen  w-full md:max-w-[97%] lg:text-base  lg:max-w-2xl"
            >
              {description}
            </Typography>
          )}
