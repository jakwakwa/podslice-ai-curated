...
const PageHeader = React.forwardRef<HTMLDivElement, PageHeaderProps>(
	({ title, description, level = 1, button }, _ref) => {
		...
		return (
			<div className="min-w-screen sm:-ml-8 md:min-w-full md:mx-0 sm:-mt-4 pb-18 md:ml-0 my-0 pt-12 mx-0  px-5 md:pb-4 md:px-8  h-fit lg:pt-6 lg:pb-4 shadow-sm bg-sidebar-ring/10  rounded-none  max-w-full outline-none w-screen  relative border-b-none md:rounded-2xl md:border-1 md:border-border/50 p-6 flex flex-col  justify-between gap-2 md:w-full mb-0 md:mb-0 md:flex-row sm:pb-12   md:shadow-foreground-muted/80 lg:shadow-xl md:items-center md:justify-between lg:mb-0 xl:py-12 md:mt-2 md:pt-0">
