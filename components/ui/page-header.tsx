...
const PageHeader = React.forwardRef<HTMLDivElement, PageHeaderProps>(({ title, description, level = 1, button }, _ref) => {
	...
	return (
		<div className="my-0 pt-12 mx-0  px-5 pb-9 md:pt-4 md:pb-4 md:px-8  h-fit lg:pt-6 lg:pb-12 shadow-sm bg-secondary rounded-none  max-w-full outline-none w-screen md:bg-secondary  relative border-b-none  md:rounded-b-3xl md:border-l-10 md:border-border  md:rounded-3xl p-6 flex flex-col  shadow-slate-700/30 md:shadow-lg justify-between gap-2 md:w-full mb-0 md:mb-0 md:flex-row lg:rounded-3xl  sm:py-12   md:shadow-slate-900/20 md:items-center md:justify-between lg:mb-0 ">
