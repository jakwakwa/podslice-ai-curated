...
const PageHeader = React.forwardRef<HTMLDivElement, PageHeaderProps>(
	({ title, description, level = 1, button }, _ref) => {
		...
		return (
			<div className="min-w-screen sm:-ml-0 sm:pt-8 md:min-w-full md:mx-8s sm:-mt-4 pb-12 md:ml-0 my-0 pt-6 mx-0  px-5  md:px-8  h-fit lg:pt-6 lg:pb-0 shadow-sm bg-gray-800/30 outline-1 backdrop-blur-sm outline-cyan-800/50 rounded-none  max-w-full w-screen  relative border-b-none md:rounded-xl md:border md:border-border/50 p-6 flex flex-col  justify-between gap-3 md:gap-8 md:w-full mb-0 md:mb-0 md:flex-row sm:pb-12   md:shadow-foreground-muted/80 lg:shadow-xl md:items-center md:justify-between lg:mb-0 xl:py-10 md:mt-2 md:py-8 md:pb-8">
