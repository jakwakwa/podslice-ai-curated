...
const PageHeader = React.forwardRef<HTMLDivElement, PageHeaderProps>(({ title, description, level = 1, button }, _ref) => {
	...
	return (
		<div className="my-0 pt-8 md:pt-4 backdrop-blur-lg bg-[#15151bd4] relative md:border-l-10 rounded-md p-6 flex flex-col border-l-0 border-0-[#867FE8DD] justify-between gap-8 w-full mb-0 md:mb-3 md:px-4 md:flex-row  shadow-black/70 shadow-lg md:justify-between ">
