		...
		<SidebarContext.Provider value={contextValue}>
			<TooltipProvider delayDuration={0}>
				<div
					...
					className={
						"group/sidebar-wrapped has-data-[variant=inset] border-none  flex h-full min-h-full w-full mt-0"
					}
					{...props}>
					{children}
				</div>
			...
			<div
				...
				className={cn(
					...
					variant === "floating" || variant === "inset"
						...
						: "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r-sidebar-border border-r-[1px solid] group-data-[side=right]:border-l",
					className
				)}
				{...props}>
				<div
...
function SidebarSeparator({
	...
	return (
		<Separator
			...
			className={cn("bg-[#ffffff0c]  w-auto", className)}
			{...props}
		/>
	);
}
	...
	return (
		<li
			...
			className={cn(
				...
				className,
				"text-custom-sm bg-sidebar-menu  content/0 	 hover:text-sm active: content/20"
			)}
			{...props}
		/>
	);
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
	return (
		<ul
			...
			className={cn(
				" mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l px-2.5 py-0",
				"group-data-[collapsible=icon]:hidden",
				className
			)}
			{...props}
