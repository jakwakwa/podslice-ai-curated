...
const Typography = React.forwardRef<HTMLElement, TypographyComponent>(
...
const H1 = (props: Omit<TypographyComponent, "variant" | "as">) => (
	<Typography variant="h1" as="h1" {...props} />
);

const H2 = (props: Omit<TypographyComponent, "variant" | "as">) => (
	<Typography variant="h2" as="h2" {...props} />
);

const H3 = (props: Omit<TypographyComponent, "variant" | "as">) => (
	<Typography variant="h3" as="h3" {...props} />
);

const H4 = (props: Omit<TypographyComponent, "variant" | "as">) => (
	<Typography variant="h4" as="h4" {...props} />
);

const H5 = (props: Omit<TypographyComponent, "variant" | "as">) => (
	<Typography variant="h5" as="h5" {...props} />
);

// Body text components
const Body = (props: Omit<TypographyComponent, "variant" | "as">) => (
	<Typography variant="body" as="p" {...props} />
);

const Muted = (props: Omit<TypographyComponent, "variant" | "as">) => (
	<Typography variant="muted" as="p" {...props} />
);

const _Span = (props: Omit<TypographyComponent, "variant" | "as">) => (
