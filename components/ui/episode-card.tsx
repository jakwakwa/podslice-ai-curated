        ...
        {(() => {
          ...
          if (youtubeUrl) {
            if (youtubeChannelImage) {
              return (
                <div className="aspect-video w-full h-fit max-h-[110px] max-w-[150px]   xl:h-42 md:h-32 sm:max-h-[110px] sm:max-w-[140px] lg:h-auto lg:max-h-[90px] lg:hidden xl:flex shadow-[1px_2px_5px_2px_#003e3cca,1px_-7px_19px_0px_#013e3cca_inset] bg-cyan-900 shadow-black/35 border-[#421b8bed] rounded-md md:rounded-lg overflow-hidden border-4	 outline-3 outline-indigo-500   lg:min-w-[160px]">
                  <Image
