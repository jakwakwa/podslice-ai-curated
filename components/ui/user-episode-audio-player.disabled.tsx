...
export default function UserEpisodeAudioPlayer({
	episode,
	onClose,
}: UserEpisodeAudioPlayerProps) {
	...
	const _truncatedDescription = useMemo(
		() => truncateDescription(episode.summary, 100),
		[episode.summary]
	);

	const audioSource = useMemo(() => {
		return episode.gcs_audio_url !== "sample-for-simulated-tests.mp3"
			? episode.gcs_audio_url
	...
	return (
		<div className={styles.userAudioPlayer}>
			<div className="gap-4 flex flex-row items-center justify-start px-2 m-0 episode-info">
				...
				<Typography className="text-xs w-full min-w-[1	00px] truncate max-w-[100px] md:max-w-none">
			...
			<div className={styles.controls}>
				...
				<div className="w-full flex items-c gap-4 min-w-24 time-display">
					<span className=" time-display text-xs mx-2 w-[20px]">
