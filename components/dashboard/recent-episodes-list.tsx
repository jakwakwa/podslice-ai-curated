...
export function RecentEpisodesList({
    ...
    return (
        <div className="bg-bigcard w-full flex flex-col gap-0 justify-start mb-0 items-start shadow-xl shadow-indigo/30 mt-0 md:m-0 xl:flex-row md:gap-4 py-8 p-1 md:mt-4 md:mb-0 border-1 md:rounded-3xl lg:pb-8 max-w-[700px] min-w-[50vw]  lg:pt-0 overflow-hidden md:p-0 md:justify-center align-start lg:mb-8">
