	...
	return (
		<div className="mb-8">
			...
			<div className="mt-6 space-y-6">
				{services.map((service, serviceIndex) => (
					<div key={`service-${serviceIndex}`}>
						<h4 className="font-bold text-lg mb-3 text-foreground">{service.heading}</h4>
			...
			<p className="mt-6 text-sm text-foreground/90 leading-relaxed">
				We maintain data processing agreements with all service providers and ensure they
				meet our privacy standards. We do not sell, rent, or trade your personal
