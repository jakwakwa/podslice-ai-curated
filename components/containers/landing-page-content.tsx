...
const SUBSCRIPTION_TIERS = PRICING_TIER.map((tier) => ({
  ...
  price:
    tier.planId === "FREE_SLICE"
      ? 0
      : tier.planId === "CASUAL_LISTENER"
        ? 5
        : 10,
...
export default function LandingPageContent() {
  ...
  return (
    <div className="max-w-full w-screen md:w-full flex flex-col justify-center items-center content-center mx-auto px-8 md:px-0 pb-4 md:py-0  gap-0 mb-0 ">
      ...
      {/* Hero Section */}
      <section
        className={`${styles.heroSection} min-w-screen my-0 py-0 mix-blend-multiply `}
      >
        <motion.div
        ...
        <div className={styles.heroContainer}>
          <div className={styles.heroContent}>
            ...
            >
              Tired of sifting through hours of podcasts for that one golden
              nugget? Podslice.ai transforms chaotic audio into crystal-clear,
          ...
          >
            <Link href="/sign-in">
              <div>
                <div className={`${styles.heroBtn} text-amber-50 `}>
                  Start Free Trial
                </div>
              </div>
            </Link>
        ...
        <div className="w-full max-w-screen md:min-w-7xl mx-auto md:px-12 px-0 py-8 md:py-24 mt-0 ">
          ...
          >
            ...
            <p className="w-full text-base md:text-center  md:mx-auto md:max-w-2xl  px-4 text-left pb-8 mt-4 sm:text-[1.4rem] my-8 leading-[1.4] text-secondary-foreground-muted/90 text-shadow-sm  font-medium text-shadow-[#3684de0c]">
              Getting started with Podslice.ai is straightforward. Follow these
              four simple steps to create your focused content experience.
            </p>
          </motion.div>
        ...
        <div className="w-full max-w-screen md:max-w-7xl mx-auto px-8 md:px-0 py-4 md:py-0 bg-radial-gradient-secondary ">
          <div>
            ...
            <Typography className="max-w-full text-base text-left md:max-w-2xl mx-auto px-4 sm:text-center pb-8 mt-4 sm:text-[1.4rem] my-8 leading-[1.4] text-[#c1f0ff]/80">
              From free discovery to pro-level curation control. Each plan
              builds on the last to give you exactly what you need.
            </Typography>
          </div>
                ...
                <div className="flex flex-col justify-start h-full min-h-[250px]">
                  ...
                  {tier.popular && (
                    ...
                    >
                      ...
                      Create your own Ai Generated Audio Summaries from any
                      podcast show
                    </Badge>
                  )}
                </div>
