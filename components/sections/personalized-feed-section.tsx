        ...
        <div className="mt-12 grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              Get summaries from popular shows and channels we've already curated for you. Just subscribe to our
              "Bundles" (e.g., "Tech Today," "Wellness Weekly," or "Finance Fast-Track"), and new audio and text
              summaries will appear in your feed automatically.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              This is where the <span className="text-pink-500 font-medium">real power lies</span>. Found a 2-hour
              interview or lecture on YouTube? Just paste the link into Podslice. Want to catch up on the latest news?
              Select your topics. Our AI will get to work and create a custom summary just for you.
            </p>
          </div>
        </div>
      </div>
