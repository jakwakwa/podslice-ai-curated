...
export default function EditUserFeedModal({
	isOpen,
	onClose,
	collection,
	onSave,
}: Readonly<EditUserFeedModalProps>): React.ReactElement {
	const [name, setName] = useState(collection?.name ?? "");
	const [selectedBundleId, setSelectedBundleId] = useState<string | undefined>(
		collection?.selected_bundle_id ?? undefined
	);
						...
						<div className="space-y-2">
							...
							<Select
								...
								<SelectTrigger>
									<SelectValue
										placeholder={
											isLoadingBundles ? "Loading bundles..." : "Select a new bundle"
										}
									/>
								</SelectTrigger>
								<SelectContent>
