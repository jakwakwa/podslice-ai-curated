...
import { Copy, Facebook, Mail, MessageCircle, X as XIcon } from "lucide-react";
...
export function ShareDialog({ open, onOpenChange, title, shareUrl, isPublic }: ShareDialogProps) {
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <Button
              ...
              variant="outline"
              size="icon"
              className="h-14 w-14 rounded-full bg-black hover:bg-gray-900 border-0"
            ...
            <Button
              ...
              variant="outline"
              size="icon"
              className="h-14 w-14 rounded-full bg-gray-600 hover:bg-gray-700 border-0"
