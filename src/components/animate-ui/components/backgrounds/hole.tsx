...
/** biome-ignore-all lint/correctness/useExhaustiveDependencies: <external> */
/** biome-ignore-all lint/a11y/noStaticElementInteractions: <external> */
"use client";
	...
	return (
		<div
			...
			className={cn(
				...
				'before:content-[""] before:absolute before:top-1/2 before:left-1/2 before:block before:size-[190%] dark:before:[background:radial-gradient(ellipse_at_50%_5%,transparent_0%,black_50%)] before:[background:radial-gradient(ellipse_at_50%_55%,transparent_70%,white_50%)] before:transform-[translate3d(-50%,-50%,0)]',
				'after:content-[""] after:absolute after:-z-1 after:top-1/2 after:left-1/2 after:block after:size-full after:[background:radial-gradient(ellipse_at_50%_75%,#a900ff_20%,transparent_65%)] after:transform-[translate3d(-50%,-50%,0)] after:mix-blend-overlay',
				className
			)}
			{...props}>
			{children}
			...
			<motion.div
				className={cn(
					...
					"dark:[background:linear-gradient(20deg,var(--color-emerald-400),var(color-emerald-600).5%,var(--color-emerald-300), #fe848f20_49.5%,var(--color-gray-800)_66%,.5%,var(--color-emerald-500) var(--color-pink-300)_100%)_0_100%_/_100%_200%] [background:linear-gradient(20deg,var(--color-emerald-700),var(--swak-2)_16.5%,var(--swak-1),var(--color-emerald-600)_49.5%,var(--swak-2),var(--color-pink-300)_85.5%,var(--swak-1)_100%)_0_100%/100%_200%]"
				)}
				animate={{ backgroundPosition: "0% 300%" }}
				transition={{ duration: 5, ease: "linear", repeat: Infinity }}
			/>
			<div className="absolute top-0 left-0 z-0 size-full dark:[background:repeating-linear-gradient(transparent,transparent_1px,white_1px,white_2px)] mix-blend-overlay opacity-50" />
		</div>
	);
}
