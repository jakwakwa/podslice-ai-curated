...
type Priority = "Crypto" | "White Paper" | "Earnings Report" | "Other";
...
const defaultDescription = "Describe your document";
...
export function DetailTaskCard() {
	...
	const _remainingCharacters = maxDescriptionLength - description.length;
	...
	const _toolbarIcons = [Bold, Italic, Underline, List, ListOrdered];
	...
	return (
		<div className="">
			<Card className="group relative w-full overflow-hidden rounded-2xl border border-border/40 bg-background/60 text-foreground backdrop-blur transition-all hover:border-border/60 hover:shadow-lg">
				...
				<CardHeader className="relative flex flex-row items-center gap-2 border-b border-border/40 bg-background/40 px-6 py-6">
