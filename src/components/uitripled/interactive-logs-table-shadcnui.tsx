...
type LogLevel = "Analysis" | "Earnings Report" | "White Paper" | "research";
...
const SAMPLE_LOGS: Log[] = [
	{
		...
		level: "Analysis",
		service: "PDF",
		message: "Semiconductor Analyst Report",
		duration: "Q4",
		status: "Research",
		tags: ["white paper", "success"],
	},
	{
		id: "2",
		timestamp: "2025-11-08T14:32:42Z",
		level: "Earnings Report",
		service: "PDF",
		message: "Request processed successfully",
		duration: "Q4",
		status: "Financial Report",
		tags: ["stocks", "nvda", "msft", "aapl"],
	},
	{
		id: "3",
			...
			<div className="flex h-full flex-col">
				<div className="border-b border-border bg-card p-6">
					<div className="space-y-4">
						<div>
							<h1 className="text-2xl font-semibold text-foreground">Vault List</h1>
							<p className="text-sm text-muted-foreground">
								{filteredLogs.length} of {SAMPLE_LOGS.length} documents/files
							</p>
						</div>
